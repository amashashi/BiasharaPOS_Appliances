...
- **➡ Next action: T3.1** — CreditAgreement module (M3 begins — the mali-kauli replacement): create from order (type, deposit, schedule generator — equal monthly or custom rows); INSTALLMENT releases goods, LAYAWAY holds units RESERVED.
