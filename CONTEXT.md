...
- **➡ Next action: T2.6** — POS PWA checkout flow (the first real UI): product search/scan, cart, customer attach, deposit/full payment, receipt print view. Closes M2. Verify is a manual script: cash sale + deposit sale ≤90s each on a tablet browser.
