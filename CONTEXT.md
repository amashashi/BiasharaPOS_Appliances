...
- **➡ Next action: T3.2** — Payment application to schedules: cash + mobile-money payments apply oldest-due-first; partial payments; settlement closes agreement (flips LAYAWAY releasable + `settledAt`).
