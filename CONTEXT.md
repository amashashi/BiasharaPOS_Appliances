...
- **➡ Next action: T2.5** — Mobile-money payment at POS via `PaymentsService` stub: initiate push, pending state, webhook confirms, auto-applies + fiscalizes. Then T2.6 (POS checkout UI) closes M2.
