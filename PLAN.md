...
- [x] **T2.2** Serial reservation & pick: reserve specific serials at order time OR defer; pick at fulfillment; release on cancel. — *Verify:* reserved serial excluded from available stock; cancel returns it; deferred order fulfills with pick.
